  ...
  return (
    <div className={classes.pagewrapper}>
      ...
      <ul>
        ...
        <li>I worked as part of a pipeline of Developers, QA Engineers and Scrum Masters to build applications used by General Electric employees both on shop floors and within GE's logistics and fulfillment teams.</li>
        <li>I created novel solutions to existing problems that were central to legacy systems and processes.</li>
        <li>Built and deployed code to a cloud environment successfully and accepted by product owners more than 50 consecutive times in my tenure at GE.</li>
      </ul>
      ...
      <ul>
        ...
        <ul>
          ...
          <li>If you need a custom website and you want someone to build it for you and offer maintenance on a yearly scale contact me at evan@welltrek.com</li>
        </ul>
    </div>
  )
}
